...
public class templat_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_templat_list);
        recview = findViewById(R.id.rv_templeat_list);
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(templat_list.this, home_screen.class);
        ...
        sharedpreferences = PreferenceManager.getDefaultSharedPreferences(templat_list.this);
    ...
    private void get_dashboard_data() {
        ...
        mysingletons.getmInstance(templat_list.this).addToRequestque(strReq);
    }
}