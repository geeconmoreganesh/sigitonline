...
import app.sign.signit_app.adapter.adpater_drafts;
...
public class drafts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview=findViewById(R.id.draft);
        ...
        tv_get_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                picker = new DatePickerDialog(drafts.this,
        ...
        bt_view_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tv_get_from_date.getText().toString().equals("")) {
                    Toast.makeText(drafts.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                } else if (tv_get_to_date.getText().toString().equals("")) {
                    Toast.makeText(drafts.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                } else {
        ...
        get_dashboard_data();
        Adpater_drafts=new adpater_drafts(arrayList,this);
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(drafts.this,home_screen.class);
                startActivity(intent);
            }
        });

        sharedpreferences= PreferenceManager.getDefaultSharedPreferences(drafts.this);
    ...
    private void get_dashboard_data() {
            ...
            public void onResponse(String response) {
                try {
...

                    {
                        ...
                        recview.setAdapter(Adpater_drafts);

                    }
                    Adpater_drafts.notifyDataSetChanged();
        ...
        mysingletons.getmInstance(drafts.this).addToRequestque(strReq);
    }

    private void getDashboardList(String from_date, String to_date) {
        arrayList.clear();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_DEV, new Response.Listener<String>() {
            @Override
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("status", "draft");
                hashMap.put("view","getDashboardList");
                hashMap.put("fromdate", drafts.this.from_date);
                hashMap.put("todate", drafts.this.to_date);
                return hashMap;
            }
        };
