...
public class Cancelled extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview=findViewById(R.id.rv_cancelled);
         ...
         bt_view_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tv_get_from_date.getText().toString().equals("")) {
                    Toast.makeText(Cancelled.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                } else if (tv_get_to_date.getText().toString().equals("")) {
                    Toast.makeText(Cancelled.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                } else {
        ...
        tv_get_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                picker = new DatePickerDialog(Cancelled.this,
        ...
        get_dashboard_data();
        Adapter_cancelled=new adapter_cancelled(arrayList,this);

        back_img=findViewById(R.id.back_img);
        back_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Cancelled.this,home_screen.class);
        ...
        sharedpreferences= PreferenceManager.getDefaultSharedPreferences(Cancelled.this);
        ...
        tv_cancelled.setText(Common.Cancelled);
    }
    ...
    private void get_dashboard_data() {
            ...
            public void onResponse(String response) {
                try {
...

                    {
                        ...
                        recview.setAdapter(Adapter_cancelled);

                    }
                    Adapter_cancelled.notifyDataSetChanged();
        ...
        mysingletons.getmInstance(Cancelled.this).addToRequestque(strReq);
    }
