...
public class adpater_rejected extends RecyclerView.Adapter<adpater_rejected.myviewholder>
{
    private ArrayList<Dashboard> arrayList;
    Context context;

    public adpater_rejected(ArrayList<Dashboard> arrayList, Context context) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.single_rejected,parent,false);
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position)
    {
        ...
        holder.Ll_rejected_docket_status.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    {
        ImageView imageView;
        LinearLayout Ll_rejected_docket_status;
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            Ll_rejected_docket_status=(LinearLayout)itemView.findViewById(R.id.Ll_rejected_docket_status);
        }
    }
}
