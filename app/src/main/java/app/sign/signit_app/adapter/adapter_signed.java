...
public class adapter_signed extends RecyclerView.Adapter<adapter_signed.myviewholder>
{
    private ArrayList<Dashboard> arrayList;
    Context context;

    public adapter_signed(ArrayList<Dashboard> arrayList, Context context) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.single_signed,parent,false);
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position)
    {
        ...
        holder.Ll_Signed_docket.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class myviewholder extends RecyclerView.ViewHolder
    {
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            Ll_Signed_docket=(LinearLayout) itemView.findViewById(R.id.Ll_Signed_docket);
