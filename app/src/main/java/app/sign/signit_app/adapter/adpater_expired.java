...
public class adpater_expired extends RecyclerView.Adapter<adpater_expired.myviewholder>
{
    private ArrayList<Dashboard> arrayList;
    Context context;

    public adpater_expired(ArrayList<Dashboard> arrayList, Context context) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.single_expired,parent,false);
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position)
    {
        ...
        holder.Ll_expired_docket_status.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class myviewholder extends RecyclerView.ViewHolder
    {
        ...
        LinearLayout Ll_expired_docket_status;
        ImageView imageView;
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            Ll_expired_docket_status=(LinearLayout) itemView.findViewById(R.id.Ll_expired_docket_status);
        }
    }
}
