...
public class adpater_drafts extends RecyclerView.Adapter<adpater_drafts.myviewholder>
{
    private ArrayList<Dashboard> arrayList;
    Context context;

    public adpater_drafts(ArrayList<Dashboard> arrayList, Context context) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.single_draft,parent,false);
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position)
    {
        ...
        holder.Ll_draft.setOnClickListener(new View.OnClickListener() {
            @Override
