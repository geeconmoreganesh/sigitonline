package app.sign.signit_app;
        ...
        import app.sign.signit_app.adapter.adpater_expired;
...
public class Expired extends AppCompatActivity {
    ...
    adpater_expired Adpater_expired;
    TextView tv_expired;
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview=findViewById(R.id.rv_expired);
        ...
        tv_get_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                picker = new DatePickerDialog(Expired.this,
        ...
        bt_view_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tv_get_from_date.getText().toString().equals("")) {
                    Toast.makeText(Expired.this, "Please Select From Date", Toast.LENGTH_SHORT).show();
                } else if (tv_get_to_date.getText().toString().equals("")) {
                    Toast.makeText(Expired.this, "Please Select To Date", Toast.LENGTH_SHORT).show();
                } else {
        ...
        get_dashboard_data();
        Adpater_expired=new adpater_expired(arrayList,this);

        back_img=findViewById(R.id.back_img);
        back_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Expired.this,home_screen.class);
        ...
        sharedpreferences= PreferenceManager.getDefaultSharedPreferences(Expired.this);
        ...
        tv_expired.setText(Common.Expired);
    }
    ...
    private void get_dashboard_data() {
            ...
            public void onResponse(String response) {
                try {
...

                    {
                        ...
                        recview.setAdapter(Adpater_expired);

                    }
                    Adpater_expired.notifyDataSetChanged();
        ...
        mysingletons.getmInstance(Expired.this).addToRequestque(strReq);
    }
